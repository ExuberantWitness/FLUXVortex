...
%% Output dir
CHECKPOINT_DIR_LOCAL = fullfile(script_dir, 'fixtures_traj_long');
...
CHECKPOINT_TIMES = [1.0000, 1.5000, 2.0000, 2.5000, 3.0000];
...
param_ver = 12.0;
End_Time = 3.06;        % full trajectory to large deformation
d_t = 2e-3;
core_num = 4;
speed_check = 0;
alpha_v = 0.5;
