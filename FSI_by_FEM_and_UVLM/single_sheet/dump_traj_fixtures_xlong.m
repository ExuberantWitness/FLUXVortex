...
%% Output dir
CHECKPOINT_DIR_LOCAL = fullfile(script_dir, 'fixtures_traj_xlong');
...
CHECKPOINT_TIMES = [2.0000, 3.0000, 4.0000, 5.0000, 6.0000];
...
param_ver = 12.0;
End_Time = 6.12;        % full trajectory to large deformation
d_t = 2e-3;
core_num = 4;
speed_check = 0;
alpha_v = 0.5;
