"""全工况逐曲线对比图(用户指令 2026-07-15):118 工况刚性模型扫(s6_sweep_v2.json,
H16pltL2/le/nc12/v2 运动学)vs 实测(repro_data.json),25+ 条曲线全画、逐曲线 MAE。
...
SW = json.load(open(os.path.join(DOCS, "s6_sweep_v2.json")))
