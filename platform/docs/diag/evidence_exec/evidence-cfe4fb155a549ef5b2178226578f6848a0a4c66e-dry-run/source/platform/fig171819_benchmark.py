...
FIG19_CD_FREQUENCY_STATUS = "unresolved"
...
def scorecard(
    ...
    *,
    ...
    gate0_identity_frozen = (
        FIG19_CD_FREQUENCY_STATUS == "resolved"
        and measurement_validation["source"]["identity_passed"]
    )
    ...
    return {
        ...
        "promotion_blockers": [
            ...
            for blocker, active in (
                ...
                ("solver_grid_incomplete", not sweep_coverage["complete"]),
                (
