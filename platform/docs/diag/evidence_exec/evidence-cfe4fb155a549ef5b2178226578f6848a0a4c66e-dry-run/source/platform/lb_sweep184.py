...
FROZEN_EXPECTED_HASHES = {
    "platform/_v2_robo.py": "eb516d6ad6ebee661bfc9b450d5a6f1d328a9fa3fcb47fcf1d9d52501b4efa80",
...
def _run_locked(
    *,
    ...
    if dry_run:
        ...
        print(
            "publication gate: CLOSED until the paper's unresolved "
            "Fig19(c,d) fixed-frequency identity is resolved"
        )
