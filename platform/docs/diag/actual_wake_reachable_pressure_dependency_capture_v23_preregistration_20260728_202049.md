...
**时间**：2026-07-28T20:20:49+08:00  
**artifact**：`actual_wake_reachable_pressure_dependency_capture_v23_preregistration_20260728_202049`  
...
fingerprint/phase/event chain exact equal
```
...
all 12 U/fingerprint/first-seen-phase/event-chain exact equal
...
```text
wheel:<normalized-name>
conda:<name>:<build>:<channel>:<subdir>
dpkg:<package>:<arch>
```

`version` 是 owner metadata 的 exact version。
...
- base 是 exact distribution root；
