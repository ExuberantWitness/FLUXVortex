...
**预注册时间**：2026-07-28T18:51:12+08:00  
**attempt id**：`S3ai-v2.2-transport-v2.3-successor-20260728_185112`  
...
`actual_wake_reachable_pressure_transport_v23_preregistration_20260728_184227`；
旧草案因独立审计发现 3 个 MD/JSON 一致性 blocker 而保留为 `FAIL` 历史，
没有被覆盖。
...
dependency manifest:
  platform/docs/diag/actual_wake_reachable_pressure_dependency_closure_v23_20260728_185112.json
authorization:
  platform/docs/diag/actual_wake_reachable_pressure_execution_authorization_v23_20260728_185112.yaml
result:
  platform/docs/diag/actual_wake_reachable_pressure_obstruction_results_s3ai_v22_transport_v23_20260728_185112.json
marker:
  platform/docs/diag/actual_wake_reachable_pressure_obstruction_results_s3ai_v22_transport_v23_20260728_185112.json.lock
interpretation contract:
  platform/docs/diag/actual_wake_reachable_pressure_result_interpretation_contract_v23_20260728_185112.{md,json}
```
