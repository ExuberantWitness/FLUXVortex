...
- **⏸ 挂起(2026-07-19,用户令"退回 v4")**:战役停在 S3 力通道案(归因已闭合,
  修法 A/B 已列,见 gap_s3_force.md)。生产口径 = v4(从未被替换;rVPM 全部改动为
  可选开关缺省关闭,退出时实测验证 U6 红线工况对 v4 缓存 Δ=+0.016/+0.007 噪声带内)。
  复盘资产全在 aero-rvpm-lev 分支,随时可续:S1/S2 已过门,S3b 稳定链七修完备,
  S3 力通道为唯一拦路案。
