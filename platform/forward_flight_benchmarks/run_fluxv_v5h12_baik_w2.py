"""No-observation runner for the V5H12 Baik-W2 execution-only repair.
...
SUMMARY_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h12-baik-w2-synthetic-summary-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h12-baik-w2-formal-summary-v2",
}
RUN_MANIFEST_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h12-baik-w2-synthetic-run-manifest-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h12-baik-w2-formal-run-manifest-v2",
}
TRAJECTORY_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h12-baik-w2-synthetic-trajectories-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h12-baik-w2-formal-trajectories-v2",
}
CONVERGENCE_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h12-baik-w2-synthetic-convergence-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h12-baik-w2-formal-convergence-v2",
}
DEPENDENCY_MANIFEST_SCHEMA_ID: Final = "fluxv-v5h12-dependency-manifest-v2"
DEPENDENCY_AUDIT_TOKEN_SCHEMA_ID: Final = "fluxv-v5h12-dependency-audit-token-v1"
...
FORMAL_EXECUTOR_FACTORY_NAME: Final = "build_fluxv_v5h12_w2_executor"
FORMAL_AUDIT_SCOPE: Final = "v5h12_execution_repair_no_gt_formal_execution"
CASE_ID: Final = "W2"
...
CANONICAL_PROJECT_LEAF_RELATIVE_PATH: Final = {
    "prereg_freeze": (
        ...
        "fluxv_v5_nextgen_20260814/refine-logs/v5h12_execution_repair/"
        "FREEZE_INPUTS.json"
    ),
    "runner": "platform/forward_flight_benchmarks/run_fluxv_v5h12_baik_w2.py",
    "runner_test": "platform/tests/test_run_fluxv_v5h12_baik_w2.py",
    "formal_executor_module": (
        "platform/forward_flight_benchmarks/fluxv_v5h12_baik_w2_executor.py"
    ),
    "formal_executor_test": "platform/tests/test_fluxv_v5h12_baik_w2_executor.py",
    "probe_source_v5h7": (
...
FORMAL_EXECUTOR_API: Final = FormalExecutorAPI(
    schema_id="fluxv-v5h12-baik-w2-formal-executor-api-v1",
...
def _load_formal_executor(
    ...
    module_name = (
        "fluxv_v5h12_w2_audited_executor_" + str(reverified["audit_token_sha256"])[:16]
    )
...
def _semantic_root(file_sha256: Mapping[str, str]) -> str:
    ...
    return _payload_sha256(
        "fluxv-v5h12-baik-w2-semantic-result-v1",
...
def verify_artifact(directory: Path) -> dict[str, object]:
    ...
    dependency_digest = _payload_sha256(
        "fluxv-v5h12-dependency-evidence-v1", expected_dependency
    )
    if (
...
def _publish_artifact_core(
    ...
    *,
    ...
    dependency_audit_sha256 = _payload_sha256(
        "fluxv-v5h12-dependency-evidence-v1", dependency_evidence
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return 2
    print(
        f"{verification['status']} v5h12 no-GT inner artifact; "
