"""No-observation runner for the V5H15 Baik-W2 execution-only repair.
...
SUMMARY_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h15-baik-w2-synthetic-summary-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h15-baik-w2-formal-summary-v2",
}
RUN_MANIFEST_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h15-baik-w2-synthetic-run-manifest-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h15-baik-w2-formal-run-manifest-v2",
}
TRAJECTORY_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h15-baik-w2-synthetic-trajectories-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h15-baik-w2-formal-trajectories-v2",
}
CONVERGENCE_SCHEMA_BY_MODE: Final = {
    SYNTHETIC_EXECUTION_MODE: "fluxv-v5h15-baik-w2-synthetic-convergence-v2",
    FORMAL_EXECUTION_MODE: "fluxv-v5h15-baik-w2-formal-convergence-v2",
}
DEPENDENCY_MANIFEST_SCHEMA_ID: Final = "fluxv-v5h15-dependency-manifest-v2"
DEPENDENCY_AUDIT_TOKEN_SCHEMA_ID: Final = "fluxv-v5h15-dependency-audit-token-v1"
...
FORMAL_EXECUTOR_FACTORY_NAME: Final = "build_fluxv_v5h15_w2_executor"
FORMAL_AUDIT_SCOPE: Final = "v5h15_execution_repair_no_gt_formal_execution"
CASE_ID: Final = "W2"
...
def graded_substep_delta_time(level: int, substep: int) -> float:
    """The frozen V5H15 birth-window dt of one graded sub-step slot."""
...
CANONICAL_PROJECT_LEAF_RELATIVE_PATH: Final = {
    "prereg_freeze": (
        ...
        "fluxv_v5_nextgen_20260814/refine-logs/v5h15_birth_sigma_scheduling/"
        "FREEZE_INPUTS.json"
    ),
    "runner": "platform/forward_flight_benchmarks/run_fluxv_v5h15_baik_w2.py",
    "runner_test": "platform/tests/test_run_fluxv_v5h15_baik_w2.py",
    "formal_executor_module": (
        "platform/forward_flight_benchmarks/fluxv_v5h15_baik_w2_executor.py"
    ),
    "formal_executor_test": "platform/tests/test_fluxv_v5h15_baik_w2_executor.py",
    "probe_source_v5h7": (
    ...
    "rvpm_ir_wrk3_v5h15_stream": "src/fluxvortex/rvpm_ir_wrk3_v5h15_stream.py",
    ...
    "v5h15_baik_coupling": (
        "platform/forward_flight_benchmarks/fluxv_v5h15_baik_coupling.py"
    ),
    "v5h3_native_feedback": (
...
FORMAL_EXECUTOR_API: Final = FormalExecutorAPI(
    schema_id="fluxv-v5h15-baik-w2-formal-executor-api-v1",
...
def _load_formal_executor(
    ...
    module_name = (
        "fluxv_v5h15_w2_audited_executor_" + str(reverified["audit_token_sha256"])[:16]
    )
...
def _id_sequence(value: object) -> dict[str, object]:
    ...
    items = list(value)
    digest = _payload_sha256("fluxv-v5h15-particle-id-sequence-v1", items)
...
def _decode_id_sequence(value: object) -> tuple[str, ...]:
    ...
    expected = _payload_sha256("fluxv-v5h15-particle-id-sequence-v1", items)
...
def _validate_owner_semantics(
    ...
    for row in owner_rows:
        ...
        if row["schema_id"] != "fluxv-v5h15-baik-w2-owner-event-v1":
...
def _validate_trajectory_metadata(row: Mapping[str, object]) -> None:
    ...
    if type(prehistory) is not list or metadata[
        "source_prehistory_manifest_sha256"
    ] != _payload_sha256("fluxv-v5h15-source-prehistory-manifests-v1", prehistory):
    ...
    if metadata["particle_id_sequence_sha256"] != _payload_sha256(
        "fluxv-v5h15-particle-id-sequence-v1", list(row["particle_ids"])
    ):
...
def _semantic_root(file_sha256: Mapping[str, str]) -> str:
    ...
    return _payload_sha256(
        "fluxv-v5h15-baik-w2-semantic-result-v1",
...
def verify_artifact(directory: Path) -> dict[str, object]:
    ...
    dependency_digest = _payload_sha256(
        "fluxv-v5h15-dependency-evidence-v1", expected_dependency
    )
    if (
...
def _publish_artifact_core(
    ...
    *,
    ...
    dependency_audit_sha256 = _payload_sha256(
        "fluxv-v5h15-dependency-evidence-v1", dependency_evidence
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return 2
    print(
        f"{verification['status']} v5h15 no-GT inner artifact; "
